...
class AuthTest {
    ...
    @Test
    @DisplayName("Should get error message if login is null")
    void shouldGetErrorIfLoginNull() {
        var registeredUser = getRegisteredUser("active");
    ...
    @Test
    @DisplayName("Should get error message if password is null")
    void shouldGetErrorIfPasswordNull() {
        var registeredUser = getRegisteredUser("active");
        $("[data-test-id='login'] .input__box .input__control").val(registeredUser.getLogin());
    ...
    @Test
    @DisplayName("Should get error message if login and password is null")
    void shouldGetErrorIfLoginAndPasswordNull() {
        var registeredUser = getRegisteredUser("active");
        $("[data-test-id='login'] .input__box .input__control").val();
        $("[data-test-id='password'] .input__box .input__control").val();
        $("[data-test-id='action-login']").click();
